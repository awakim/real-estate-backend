...
func TestTransferAPI(t *testing.T) {
	...
	propertyID1 := util.RandomPropertyID()
	propertyID2 := util.RandomPropertyID()
	account1.PropertyID = propertyID1
	account2.PropertyID = propertyID1
	account3.PropertyID = propertyID2
